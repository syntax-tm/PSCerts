...
namespace PSCerts
{
    [Cmdlet(VerbsCommon.Find, "CertPrivateKey", DefaultParameterSetName = CERT_PARAM_SET)]
    [OutputType(typeof(FileInfo))]
    public class FindCertPrivateKeyCommand : PSCmdlet
    {
        ...
        [Parameter(
            ...
            ParameterSetName = CERT_PARAM_SET)]
        ...
        [Parameter(
            ...
            ValueFromPipelineByPropertyName = true,
            ParameterSetName = FIND_PARAM_SET)]
        [Alias("Thumbprint", "CN", "CommonName", "Subject")]
